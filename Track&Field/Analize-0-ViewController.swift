...
class Analize_0_ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        startday_picture.layer.cornerRadius = 30
        startday_picture.backgroundColor = UIColor(red: 250, green: 250, blue: 250, alpha: 1.0)//塗り潰し
        ...
        endday_picture.layer.cornerRadius = 30
        endday_picture.backgroundColor = UIColor(red: 250, green: 250, blue: 250, alpha: 1.0)//塗り潰し
        ...
        graphKey1_picture.layer.cornerRadius = 30
        graphKey1_picture.backgroundColor = UIColor(red: 250, green: 250, blue: 250, alpha: 1.0)//塗り潰し
        ...
        graphKey2_picture.layer.cornerRadius = 30
        graphKey2_picture.backgroundColor = UIColor(red: 250, green: 250, blue: 250, alpha: 1.0)//塗り潰し
